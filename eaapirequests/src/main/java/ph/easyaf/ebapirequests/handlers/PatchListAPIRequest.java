...
public class PatchListAPIRequest extends APIRequest<String, Integer, JSONArray> {

    private JSONArray objectToPass;

    public PatchListAPIRequest(int requestCode, String methodPath,
